...
public class HareParser implements PsiParser, LightPsiParser {
  ...
  static boolean binding1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "binding1")) return false;
    if (!nextTokenIs(b, IDENTIFIER)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, IDENTIFIER);
    p = r; // pin = 1
    r = r && report_error_(b, binding1_1(b, l + 1));
  ...
  // (COLON type)?
  private static boolean binding1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "binding1_1")) return false;
    binding1_1_0(b, l + 1);
    return true;
  }

  // COLON type
  private static boolean binding1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "binding1_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  static boolean binding2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "binding2")) return false;
    if (!nextTokenIs(b, LP)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeTokens(b, 1, LP, IDENTIFIER);
    p = r; // pin = 1
    r = r && report_error_(b, binding2_2(b, l + 1));
    r = p && report_error_(b, consumeTokens(b, -1, RP, ASSIGN)) && r;
    r = p && expression(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // (COMMA IDENTIFIER)+
  private static boolean binding2_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "binding2_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = binding2_2_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!binding2_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "binding2_2", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // COMMA IDENTIFIER
  private static boolean binding2_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "binding2_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  public static boolean binding_list(PsiBuilder b, int l) {
    ...
    r = let_bindings(b, l + 1);
    if (!r) r = const_bindings(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  static boolean const_bindings(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "const_bindings")) return false;
    if (!nextTokenIs(b, "", CONST_KW, STATIC_KW)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = const_bindings_0(b, l + 1);
  ...
  // STATIC_KW*
  private static boolean const_bindings_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "const_bindings_0")) return false;
    while (true) {
      int c = current_position_(b);
      if (!consumeToken(b, STATIC_KW)) break;
      if (!empty_element_parsed_guard_(b, "const_bindings_0", c)) break;
    }
    return true;
  }
  ...
  public static boolean constant_binding(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, IDENTIFIER)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, CONSTANT_BINDING, null);
  ...
  public static boolean expression_list(PsiBuilder b, int l) {
    ...
    r = expression_with_ending(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!expression_with_ending(b, l + 1)) break;
  ...
  /* ********************************************************** */
  // expression EOS
  static boolean expression_with_ending(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "expression_with_ending")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = expression(b, l + 1);
    p = r; // pin = 1
  ...
  public static boolean for_loop(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, for_predicate(b, l + 1));
  ...
  /* ********************************************************** */
  // fndec_attr* FN_KW identifier_path prototype function_definition?
  ...
  static boolean global_const_bindings(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_const_bindings")) return false;
  ...
  /* ********************************************************** */
  // global_let_bindings | global_const_bindings
  public static boolean global_declaration(PsiBuilder b, int l) {
    ...
    r = global_let_bindings(b, l + 1);
    if (!r) r = global_const_bindings(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  static boolean global_let_bindings(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "global_let_bindings")) return false;
    if (!nextTokenIs(b, LET_KW)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
  ...
  static boolean let_bindings(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "let_bindings")) return false;
    if (!nextTokenIs(b, "", LET_KW, STATIC_KW)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = let_bindings_0(b, l + 1);
  ...
  // STATIC_KW*
  private static boolean let_bindings_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "let_bindings_0")) return false;
    while (true) {
      int c = current_position_(b);
      if (!consumeToken(b, STATIC_KW)) break;
      if (!empty_element_parsed_guard_(b, "let_bindings_0", c)) break;
    }
    return true;
  }
