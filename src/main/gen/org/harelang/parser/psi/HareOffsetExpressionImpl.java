...
public class HareOffsetExpressionImpl extends ASTWrapperPsiElement implements HareOffsetExpression {

  public HareOffsetExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
