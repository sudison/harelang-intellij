...
public class HareCaseOptionsImpl extends ASTWrapperPsiElement implements HareCaseOptions {

  public HareCaseOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HareVisitor visitor) {
    visitor.visitCaseOptions(this);
  }
