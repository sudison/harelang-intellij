...
public class HareConditionalBranchImpl extends ASTWrapperPsiElement implements HareConditionalBranch {

  public HareConditionalBranchImpl(@NotNull ASTNode node) {
    super(node);
  }
