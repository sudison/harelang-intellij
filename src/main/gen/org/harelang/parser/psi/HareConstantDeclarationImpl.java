...
public class HareConstantDeclarationImpl extends ASTWrapperPsiElement implements HareConstantDeclaration {

  public HareConstantDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
