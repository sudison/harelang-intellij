...
public class HareStructInitializerImpl extends ASTWrapperPsiElement implements HareStructInitializer {

  public HareStructInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
