...
public class HareInsertExpressionImpl extends ASTWrapperPsiElement implements HareInsertExpression {

  public HareInsertExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
